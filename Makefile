...
# Project:  Game.pro
# Template: app
# Command: C:\Qt\Qt5.5.1\5.5\mingw492_32\bin\qmake.exe -spec win32-g++ -o Makefile Game.pro
#############################################################################
...
Makefile: Game.pro C:/Qt/Qt5.5.1/5.5/mingw492_32/mkspecs/win32-g++/qmake.conf C:/Qt/Qt5.5.1/5.5/mingw492_32/mkspecs/features/spec_pre.prf \
		...
		contrib/Magic3D_Base.pro \
		contrib/Magic3D_Base_Include.pro \
		Magic3D_Engine.pro \
