...
import br.com.magictech.game.Game;
...
class SDLSurface extends GLSurfaceView implements SurfaceHolder.Callback,
    ...
    public void onSensorChanged(SensorEvent event) {
        if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            z = event.values[2] / SensorManager.GRAVITY_EARTH - 1;
            SDLActivity.onNativeAccel(x, y, z);
            Game.onNativeAccel(x, y, z);
        }
